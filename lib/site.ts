export const SITE = {
  name: "Aii Robots",
  domain: "aiirobots.co.za",
  url: "https://aiirobots.co.za",
...
export const SERVICES = [
  ...
  },
  {
    ...
    icon: "Bot",
    features: [
      "Website lead generation bots",
      "Support bots with knowledge base (RAG)",
      "WhatsApp/Facebook/Instagram channels",
      "Seamless handoff to human agents",
      "Analytics & conversation insights",
      "CRM integrations & lead scoring"
    ],
    tools: ["Sheets/Notion", "HubSpot/Zoho/Pipedrive", "Make/Zapier", "OpenAI/Claude"]
  },
  {
    title: "Cloud & DevOps",
    ...
    tools: ["Azure/AWS", "GitHub Actions", "Docker", "OpenTelemetry", "Terraform"]
  }
];
...
export const TESTIMONIALS = [
  ...
  },
  {
    name: "Jared P.",
    role: "Logistics Ops",
    content: "Our internal dashboard saves the team hours weekly. Solid execution, zero fluff.",
    rating: 5
  },
  {
    name: "Thandi N.",
